...
$(document).submit(function () {
    ...
    <body>
        ...
        <div class="header">
            ...
            <div class="container">
                <form id="order" class="contactform style4 clearfix" method="post" action="{{route('orders_en.new.post')}}" 
                    ...
                    <div class="row">           
                        ...
                        <div class="attachment">
                            <label class="btn btn-default btn-file">
                              ...
                              <button class="add_more">   Add more file</button>
                        </div>
                        ...
                        <div class="op col-md-6 col-md-offset-4">
                            <button type="submit" class="btn btn-primary">
                                <i class="fa fa-btn fa-ticket"></i> Open  
                            </button>
                        </div>
                    </div>
                </form>
