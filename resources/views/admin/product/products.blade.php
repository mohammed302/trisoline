...
<div class="page-fixed-main-content">
    <div class="portlet box blue">
        <div class="portlet-title">
            <div class="caption">
                <i class="fa fa-globe" aria-hidden="true"></i>الأعمال</div>
            <div class="tools"> </div>
        </div>
        <div class="portlet-body ">
            <a href="{{ Route('products.create')}}" class="btn blue">إضافة</a>
            <br>
            <br>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td data-title="خيارات">
                            ...
                            <a href="#"	value="{{route("products.destroy",$c)}}"
                               data-token="{{ csrf_token() }}"
                               data-id="{{ $c->id }}" 
                               class="delete-post-link"
                               > <i class="fa fa-trash" aria-hidden="true"></i>
                            </a>
                            <a href="{{route("products.edit",$c)}}" >
