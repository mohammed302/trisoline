...
<div class="page-fixed-main-content">
    <div class="portlet box blue">
        <div class="portlet-title">
            <div class="caption">
                <i class="fa fa-globe" aria-hidden="true"></i>الأخبار</div>
            <div class="tools"> </div>
        </div>
        <div class="portlet-body ">
            <a href="{{ Route('news.create')}}" class="btn blue">إضافة</a>
            <br>
            <br>
...
">
                        ...
                        <td  class='noter' data-title="الخبر">{{$c->title }}
                        ...
                        <td data-title="خيارات">
                            ...
                            <a href="#"	value="{{route("news.destroy",$c)}}"
                               data-token="{{ csrf_token() }}"
                               data-id="{{ $c->id }}" 
                               class="delete-post-link"
                               > <i class="fa fa-trash" aria-hidden="true"></i>
                            </a>
                            <a href="{{route("news.edit",$c)}}" >
