    ...
    <div class="portlet box blue ">
        <div class="portlet-title">
            <div class="caption">
                ...
                <span class="caption-subject  sbold uppercase">تعديل موظف</span>
            </div>
        ...
        <div class="portlet-body form">
            <form class="form-horizontal" method="post"  id="myform"
                  ...
                  action="{{route('emps.update',['admin'=>$admin])}}" role="form">
                     ...
                     <div class="form-group ">
                        ...
                        <div class="col-md-3">
                            ...
                            <select class="form-control" name="department">
                                ...
                                <option value="{{$d->id}} " @if($admin->department==$d->id)selected=""@endif>{{$d->name}}</option>
                                @endforeach 
                            </select>
                        </div>
                    </div>
                    <div class="form-group  {{ $errors->has('name') ? ' has-error' : '' }}">
                        ...
                        <div class="col-md-3">
                            ...
                            <select class="form-control" name="branch">
                                ...
                                @if(Auth::user()->type==1)
                              <option value="1"@if($admin->branch==1)selected=""@endif>الرياض</option>
                                <option value="2"@if($admin->branch==2)selected=""@endif>الصين</option>
                                <option value="3"@if($admin->branch==3)selected=""@endif>تركيا</option>
                                @else
