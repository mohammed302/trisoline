@extends('admin.app')
@section('title', 'عرض  مدراء الفروع')
@section('breadcrumb')
<ul class="page-breadcrumb">
    <li>
        <a href="{{url('')}}">   </a>
    </li>
    <li>عرض  مدراء الفروع</li>
</ul>
@endsection
@section('content')
<div class="page-fixed-main-content">
    <div class="portlet box blue">
        <div class="portlet-title">
            <div class="caption">
                <i class="fa fa-user-secret" aria-hidden="true"></i>عرض  مدراء الفروع</div>
            <div class="tools"> </div>
        </div>
        <div class="portlet-body ">
            <a href="{{ Route('subadmins.create')}}" class="btn blue">إضافة</a>
            <br>
            <br>
...
@if(sizeof($c->orders)==0)
                            ...
                            <a	href="#"  value='{{route("subadmins.destroy",["admin" =>$c])}}'
...
@endif
                            ...
                            <a href="{{route("subadmins.edit",["admin" =>$c])}}" >
