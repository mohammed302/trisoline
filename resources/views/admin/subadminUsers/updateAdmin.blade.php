@extends('admin.app')
@section('title', 'تعديل مدير فرع')
@section('breadcrumb')
<ul class="page-breadcrumb">
    <li>
        <a href="{{url('')}}">    </a>
    </li>
    <li>تعديل مدير فرع</li>
</ul>
@endsection
@section('content')
    ...
    <div class="portlet box blue ">
        <div class="portlet-title">
            <div class="caption">
                ...
                <span class="caption-subject  sbold uppercase">تعديل مدير فرع</span>
            </div>
        ...
        <div class="portlet-body form">
            <form class="form-horizontal" method="post"  id="myform"
                  ...
                  action="{{route('subadmins.update',['admin'=>$admin])}}" role="form">
