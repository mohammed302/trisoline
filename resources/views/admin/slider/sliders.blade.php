@extends('admin.app')
@section('title', 'عرض  صور السلايدر')
@section('breadcrumb')
...
<div class="page-fixed-main-content">
    <div class="portlet box blue">
        <div class="portlet-title">
            <div class="caption">
                <i class="fa fa-globe" aria-hidden="true"></i>  صور السلايدر</div>
            <div class="tools"> </div>
        </div>
        <div class="portlet-body ">
            <a href="{{ Route('sliders.create')}}" class="btn blue">إضافة</a>
            <br>
            <br>
...
">
                        ...
                        <td data-title="خيارات">
                            ...
                            <a href="#"	value="{{route("sliders.destroy",$c)}}"
                               data-token="{{ csrf_token() }}"
                               data-id="{{ $c->id }}" 
                               class="delete-post-link"
                               > <i class="fa fa-trash" aria-hidden="true"></i>
                            </a>
                            <a href="{{route("sliders.edit",$c)}}" >
