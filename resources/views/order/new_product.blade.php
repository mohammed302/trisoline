...
$(document).submit(function () {
    ...
    <body>
        ...
        <div class="header">
            ...
            <div class="hed">  
                <h1>منتج  <span style="color:red"> جديد </span></h1>
            </div>
            @if (count($errors) > 0)
            ...
            <div class="container">
                <form id="order" class="contactform style4 clearfix" method="post" 
                      action="{{route('orders.new_product.store')}}" 
                    ...
                    <div class="row">           
                        ...
                        <div class="open col-lg-12 nopadding ">
                            ...
                            <input type="text" class="form-control" name="title_e"  placeholder="العنوان بالانجليزي">  
                        ...
                        <div class="op col-md-6 col-md-offset-4">
                            <button type="submit" class="btn btn-primary">
                                <i class="fa fa-btn fa-ticket"></i> اضافة 
                            </button>
                        </div>
                    </div>
                </form>
